...
public class NumericPolyDeserialize extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 530043797;
    ...
    public NumericPolyDeserialize() {
        super("numeric_poly_deserialize", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
