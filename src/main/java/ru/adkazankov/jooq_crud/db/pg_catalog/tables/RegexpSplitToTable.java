...
public class RegexpSplitToTable extends TableImpl<RegexpSplitToTableRecord> {
    ...
    private static final long serialVersionUID = -1000565709;
     ...
     */
    public RegexpSplitToTable call(String __1, String __2) {
     ...
     * Call this table-valued function
     */
    public RegexpSplitToTable call(Field<String> __1, Field<String> __2) {
        return new RegexpSplitToTable(DSL.name(getName()), null, new Field[] { 
              __1
            , __2
        });
