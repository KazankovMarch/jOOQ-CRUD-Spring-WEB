...
public class NumericAvgDeserialize extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1540121171;
    ...
    public NumericAvgDeserialize() {
        super("numeric_avg_deserialize", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
