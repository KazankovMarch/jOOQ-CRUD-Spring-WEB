...
public class _PgTruetypid extends AbstractRoutine<Long> {
    ...
    private static final long serialVersionUID = 1333567698;
     ...
     */
    public static final Parameter<PgAttributeRecord> _1 = createParameter("_1", ru.adkazankov.jooq_crud.db.pg_catalog.tables.PgAttribute.PG_ATTRIBUTE.getDataType(), false, true);

    /**
     * The parameter <code>information_schema._pg_truetypid._2</code>.
     */
    public static final Parameter<PgTypeRecord> _2 = createParameter("_2", ru.adkazankov.jooq_crud.db.pg_catalog.tables.PgType.PG_TYPE.getDataType(), false, true);
